...
function BMIResults() {
    ...
    const weight = UserAnswers.find((answer) => answer.question === "weight")?.answer || "85"; // default weight
    const height = UserAnswers.find((answer) => answer.question === "height")?.answer || "175"; // default height
    const unit = UserAnswers.find((answer) => answer.question === "unit")?.answer || "metric";
    ...
    useEffect(() => {
        const calculatedBMI = calculateBMIwithTemporaryData(unit as "metric" | "imperial", weight, height);
        ...
        <View style={styles.container}>
            ...
            <View style={styles.main}>
                <View style={styles.middle}>
                    ...
                    <Text style={styles.sloganRegular}>Overweight</Text>
